...
export class ProfilePointStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: ProfilePointProps) {
    ...
    this.postProfilePointFunction = new NodejsFunction(
      this,
      'postProfilePoint',
      {
    ...
    this.postProfilePointFunction.addToRolePolicy(
      new PolicyStatement({
        resources: [profilePointTable.tableArn],
    ...
    this.getProfilePointFunction.addToRolePolicy(
      new PolicyStatement({
        resources: [profilePointTable.tableArn, pointEventTable.tableArn],
